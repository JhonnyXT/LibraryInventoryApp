  ...
  try {
    ...
    for (const user of users) {
      try {
        ...
        const htmlContent = `<html><body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;"><div style="background: #1976D2; color: white; padding: 20px; text-align: center;"><h1>Sistema de Biblioteca</h1><h2>Nueva version ${version} disponible</h2></div><div style="background: #f9f9f9; padding: 20px; margin-top: 10px;"><p>Hola ${cleanName},</p><p>Nueva version del Sistema de Biblioteca con mejoras importantes.</p><h3>Principales mejoras:</h3><ul><li>Sistema UX/UI profesional con Material Design 3</li><li>Google Sign-In completamente funcional</li><li>Automatizacion completa del sistema</li><li>APK firmada optimizada</li></ul><p style="text-align: center; margin: 20px 0;"><a href="${releaseUrl}" style="background: #4CAF50; color: white; padding: 10px 20px; text-decoration: none;">Descargar Version ${version}</a></p><h3>Instalacion:</h3><ol><li>Haz clic en el enlace de descarga</li><li>Busca el archivo LibraryInventoryApp-v${version}.apk</li><li>Permite fuentes desconocidas en Android</li><li>Instala la nueva version</li></ol><p>Gracias por usar el Sistema de Biblioteca.</p></div></body></html>`;
